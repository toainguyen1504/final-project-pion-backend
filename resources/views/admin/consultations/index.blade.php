            ...
            <table class="table table-bordered align-middle table-striped table-hover" id="consultations-table">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-center" style="min-width: 100px;">Người gửi</th>
                        ...
                        <th class="text-center" style="min-width: 160px;">Ngày tạo</th>
                ...
                <tbody>
                    @forelse ($consultations as $index => $item)
                        <tr>
                            ...
                            <td class="text-center">{{ $item->user_name ?? $item->guest_name }}</td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2 flex-wrap">
                                    <a href="#" class="btn btn-dark btn-sm py-1 px-3">Xem</a>
