    ...
    <div class="sidebar-brand">
        <a href="/" class="brand-link d-flex align-items-center text-decoration-none">
            <img src="{{ asset('adminAssets/img/logo_icon.png') }}" alt="Pion"
                class="brand-image img-circle elevation-3 d-flex items-center" style="width: 36px; height: 36px;">
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                {{-- Show if it is admin or staff or staffads --}}
                @if (Auth::user()?->hasRole('admin') || Auth::user()?->hasRole('staff') || Auth::user()?->hasRole('staffads'))
                    <li class="nav-item">
